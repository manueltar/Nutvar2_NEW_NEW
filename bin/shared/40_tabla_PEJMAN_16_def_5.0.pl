...
if(exists($genes{$SYMBOL_tok}))
{
	#~ print "NMD_ratio_hash{$ENST_tok\t$NMD_def\t$NMD_derived_def\n";
	#~ exit;
}
...
##########################################################	Ratio NMD		###############################################################################
			...
			if(exists($genes{$SYMBOL_tok}))
			{
				#~ print "NMD_array:\t@NMD_array\n";
				#~ print "NMD_derived_array:\t@NMD_derived_array\n";
			}
			 ...
			 if(exists($genes{$SYMBOL_tok}))
			 {
				 #~ print "RESULTS_hash\t$CHROM_tok\t$SYMBOL_tok\t$POS_tok\t$REF_tok\t$ALT_tok\t$Effect_tok_definitive\t'NMD'\t$ratio_NMD\n";
				 #~ print "RESULTS_hash{$CHROM_tok\t$SYMBOL_tok\t$POS_tok\t$REF_tok\t$ALT_tok\t$Effect_tok_definitive\t'NMD_derived'\t$ratio_NMD_derived\n";
				 #~ exit;
			 }
