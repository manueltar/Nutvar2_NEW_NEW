...
{
foreach my $CHROM_tok(sort keys%hash_NMD)
{
...
{
foreach my $CHROM_tok(sort keys%hash_NMD_derived)
{
...
{
foreach my $CHROM_tok(sort keys%hash_ENST)
{
...
{
foreach my $CHROM_tok(sort keys%hash_ENST_full_condensed)
{
...
{
foreach my $CHROM_tok(sort  keys %hash_first_table)
{
